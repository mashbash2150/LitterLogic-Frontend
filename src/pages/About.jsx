    ...
    <div className="about-container">
      ...
      <div className="about-text">
        ...
        <div>Sure, Feta <em>IS</em> awesome, however I created this app not because I think cats are cool, but because I think electronics are!
          ...
          The device detects minor shifts in environmental temperature, and interprets them as a motion event, changing the state of the sensor from low to high voltage (or vice versa).  When this occurs,a POST request is made to my express API, and further parsing of the payload happens downstream.
